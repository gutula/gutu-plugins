...
Catalog repository for first-party Gutu plugins and operating-model packs.

This catalog is a **truth-first index** for the extracted plugin ecosystem. Gutu’s current product story is a governed work OS at the core plus optional operating-model packs on top. The badges and maturity labels referenced here are local-status documentation badges backed by repo facts, not live npm or GitHub Actions badges.

## Live Catalog Surface

- `catalog/index.json` tracks the full first-party plugin and pack inventory.
...
| [Automation Core](https://github.com/gutula/gutu-plugin-automation-core) | Platform Backbone | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | [README](https://github.com/gutula/gutu-plugin-automation-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-automation-core/blob/main/DEVELOPER.md) |
...
| [Company Builder Core](https://github.com/gutula/gutu-plugin-company-builder-core) | Operating-Model Packs | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | [README](https://github.com/gutula/gutu-plugin-company-builder-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-company-builder-core/blob/main/DEVELOPER.md) |
...
| [AI Core](https://github.com/gutula/gutu-plugin-ai-core) | AI Systems | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Jobs+Workflows+UI | [README](https://github.com/gutula/gutu-plugin-ai-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-ai-core/blob/main/DEVELOPER.md) |
| [AI Evals](https://github.com/gutula/gutu-plugin-ai-evals) | AI Systems | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | [README](https://github.com/gutula/gutu-plugin-ai-evals#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-ai-evals/blob/main/DEVELOPER.md) |
| [AI RAG](https://github.com/gutula/gutu-plugin-ai-rag) | AI Systems | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | [README](https://github.com/gutula/gutu-plugin-ai-rag#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-ai-rag/blob/main/DEVELOPER.md) |
| [AI Skills Core](https://github.com/gutula/gutu-plugin-ai-skills-core) | AI Systems | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | [README](https://github.com/gutula/gutu-plugin-ai-skills-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-ai-skills-core/blob/main/DEVELOPER.md) |
| [Execution Workspaces Core](https://github.com/gutula/gutu-plugin-execution-workspaces-core) | AI Systems | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | [README](https://github.com/gutula/gutu-plugin-execution-workspaces-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-execution-workspaces-core/blob/main/DEVELOPER.md) |
| [Integration Core](https://github.com/gutula/gutu-plugin-integration-core) | AI Systems | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | [README](https://github.com/gutula/gutu-plugin-integration-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-integration-core/blob/main/DEVELOPER.md) |
| [Issues Core](https://github.com/gutula/gutu-plugin-issues-core) | AI Systems | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | [README](https://github.com/gutula/gutu-plugin-issues-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-issues-core/blob/main/DEVELOPER.md) |
| [Runtime Bridge Core](https://github.com/gutula/gutu-plugin-runtime-bridge-core) | AI Systems | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | [README](https://github.com/gutula/gutu-plugin-runtime-bridge-core#readme) · [DEVELOPER](https://github.com/gutula/gutu-plugin-runtime-bridge-core/blob/main/DEVELOPER.md) |
...
| [Automation Core](https://github.com/gutula/gutu-plugin-automation-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | Typed routines, autopilot issue-drive flows, follow-up inboxes, and concurrency-aware automation loops. |
...
| Plugin | Maturity | Verification | DB | Integration | Highlights |
| --- | --- | --- | --- | --- | --- |
| [AI Core](https://github.com/gutula/gutu-plugin-ai-core) | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Jobs+Workflows+UI | Durable agent runtime, prompt governance, approval queues, evidence views, and replay controls. |
| [AI Evals](https://github.com/gutula/gutu-plugin-ai-evals) | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | Eval datasets, baseline lineage, release gates, and replay-linked AI review. |
| [AI RAG](https://github.com/gutula/gutu-plugin-ai-rag) | `Hardened` | Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | Tenant-safe memory collections, retrieval diagnostics, freshness governance, and grounded knowledge pipelines. |
| [AI Skills Core](https://github.com/gutula/gutu-plugin-ai-skills-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | Typed governed skills, runtime-local skill import, assignment sync, and publishable agent profiles. |
| [Execution Workspaces Core](https://github.com/gutula/gutu-plugin-execution-workspaces-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+UI | Governed workspaces and runtime-service lifecycle controls for execution environments. |
| [Integration Core](https://github.com/gutula/gutu-plugin-integration-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | Connector definitions, authorization, webhook ingress, and integration health control plane. |
| [Issues Core](https://github.com/gutula/gutu-plugin-issues-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | Collaboration projects, issues, inboxes, attachments, activity, and resumable issue sessions for governed AI operators. |
| [Runtime Bridge Core](https://github.com/gutula/gutu-plugin-runtime-bridge-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | Runtime registration, watched workspaces, provider detection, local skill discovery, and resumable runtime sessions. |

## Operating-Model Packs

| Plugin | Maturity | Verification | DB | Integration | Highlights |
| --- | --- | --- | --- | --- | --- |
| [Company Builder Core](https://github.com/gutula/gutu-plugin-company-builder-core) | `Hardened` | Docs+Build+Typecheck+Lint+Test+Contracts+Integration+Migrations | postgres + sqlite | Actions+Resources+Builders+UI | Pack 0 company and department operating model layered on the hardened AI, skills, collaboration, runtime bridge, integration, automation, and execution surfaces. |
...
- Every plugin repo or operating-model pack is expected to publish a public `README.md`, a deep `DEVELOPER.md`, and a repo-local `TODO.md`.
...
- The current top-level story is a governed work OS plus optional operating-model packs; the company metaphor is layered, not universal.
- Skills, integrations, routines, execution workspaces, collaboration, and runtime bridges are now first-class platform plugins rather than implicit behavior hidden inside Pack 0.
